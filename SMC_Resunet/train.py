...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r"C:\Users\15089\Desktop\SMC_ResUnet\data/", help="VOCdevkit root")             # 数据集路径
    ...
    parser.add_argument("--epochs", default=51, type=int, metavar="N",                                                  # epochs
